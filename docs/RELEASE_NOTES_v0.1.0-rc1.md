# Kairo Desktop v0.1.0-rc1 — Release Notes
...
This is the first Release Candidate. It has passed all automated quality gates and a closed beta cycle on the development machine. No external testers participated (see Accepted Gaps below).
...
3. Run installer. Click "More info" then "Run anyway" on SmartScreen warning (unsigned beta).
...
These gaps were explicitly accepted by the Director via CONDITIONAL GO ratification:
...
_[Proposed: Claude] -- Release Notes v0.1.0-rc1_
