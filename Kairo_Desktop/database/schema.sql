-- Kairo Desktop database schema — DEC-023 (frozen)
-- 7 tables as defined in PRD v3.1 §15
--
-- IMPORTANT: This file is the canonical human-readable reference.
-- The runtime copy is embedded in database.service.ts (getSchemaSQL()).
-- If you edit this file, update the embedded copy too.
--
-- PRAGMAs (foreign_keys, WAL, synchronous) are set programmatically,
-- not in this file.
